/datum/map/tyclo_pluto
	...
	apc_test_exempt_areas = list(
		...
		// Evacuation shuttles
		/area/pluto/lifepod/bottom1 = NO_VENT|NO_SCRUBBER,
		/area/pluto/lifepod/bottom2 = NO_VENT|NO_SCRUBBER,
		/area/pluto/lifepod/bottom3 = NO_VENT|NO_SCRUBBER,
		/area/pluto/lifepod/bottom4 = NO_VENT|NO_SCRUBBER,
		/area/pluto/lifepod/bottom5 = NO_VENT|NO_SCRUBBER,

		// Shuttles
		/area/supply_drone/dock = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/courier_shuttle/pluto/utility = NO_SCRUBBER,
		/area/exploration_shuttle/pluto/airlock = NO_SCRUBBER,

		// Lifts
		/area/cargo_lift/pluto/lift = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/turbolift/pluto/first_deck = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/turbolift/pluto/second_deck = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/turbolift/pluto/third_deck = NO_SCRUBBER|NO_VENT|NO_APC,
