/decl/cultural_info/culture/common
	language = LANGUAGE_SPACER
	default_language = LANGUAGE_SPACER
	secondary_langs = list(LANGUAGE_SOL_COMMON, LANGUAGE_SIGN, LANGUAGE_GALCOM)
	name_language = LANGUAGE_SPACER

/decl/cultural_info/culture/common/spacer
	name = CULTURE_SPACER
...
/decl/cultural_info/culture/common/rimmer
	name = CULTURE_RIMMER
