...
#define UI_WARNING_TOXIN "EAST-1:28,NORTH-2:27"
#define UI_WARNING_FIRE "EAST-1:28,NORTH-3:25"
#define UI_WARNING_OXYGEN "EAST-1:28,NORTH-4:23"
#define UI_WARNING_PRESSURE "EAST-1:28,NORTH-5:21"
...
#define UI_METER_INTERNAL "EAST+1,NORTH-1"
