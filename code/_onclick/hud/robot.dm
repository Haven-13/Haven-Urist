...
//Module select
	...
	using.screen_loc = UI_INVENTORY_1
	src.adding += using
	myrobot.inv1 = using
	...
	using.screen_loc = UI_INVENTORY_2
	src.adding += using
	myrobot.inv2 = using
	...
	using.screen_loc = UI_INVENTORY_3
	src.adding += using
	myrobot.inv3 = using
...
//Cell
	...
	myrobot.cells.screen_loc = UI_WARNING_TOXIN
...
//Health
	...
	mymob.healths.screen_loc = UI_METER_HEALTH_BORG
...
//Store
	...
	mymob.throw_icon.screen_loc = UI_BORG_STORAGE
