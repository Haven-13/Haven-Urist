...
/var/datum/announcement/minor/minor_announcement = new(new_sound = 'resources/sound/AI/commandreport.ogg',)
...
/datum/announcement/priority/command/New(var/do_log = 1, var/new_sound = 'resources/sound/misc/notice2.ogg', var/do_newscast = 0)
