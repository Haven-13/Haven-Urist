...
/datum/evacuation_controller/shuttle
	...
	evac_waiting =  new(0, new_sound = sound('resources/sound/AI/shuttledock.ogg'))
	evac_called =   new(0, new_sound = sound('resources/sound/AI/shuttlecalled.ogg'))
	evac_recalled = new(0, new_sound = sound('resources/sound/AI/shuttlerecalled.ogg'))
