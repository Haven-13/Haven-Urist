...
/repository/area/proc/get_areas_by_name(var/list/area_predicates = GLOBAL_PROC_REF(is_not_space_area))
...
/repository/area/proc/get_areas_by_name_and_coords(var/list/area_predicates = GLOBAL_PROC_REF(is_not_space_area))
...
/repository/area/proc/get_areas_by_z_level(var/list/area_predicates = GLOBAL_PROC_REF(is_not_space_area))
