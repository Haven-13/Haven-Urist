...
/datum/trader/xeno_shop
	...
	possible_origins = list(
		"XenoHugs","NT Specimen Acquisition",
		"Lonely Pete's Exotic Companionship",
		"Space Wei's Exotic Cuisine"
	)
	speech = list(
		"hail_generic"    = "Welcome! We are always looking to acquire more exotic life forms.",
...
/datum/trader/medical
	...
	possible_origins = list(
		...
		"Legit Medical Supplies (No Refund)",
		"Mom's & Pop's Addictive Opoids",
		"Legitimate Pharmaceutical Firm",
		"Designer Drugs by Lil Xanny"
	)
	speech = list(
		"hail_generic"    = "Huh? How'd you get this number?! Oh well, if you wanna talk biz, I'm listening.",
	...
	possible_wanted_items = list(
		/obj/item/weapon/reagent_containers/food/drinks/bottle = TRADER_THIS_TYPE,
