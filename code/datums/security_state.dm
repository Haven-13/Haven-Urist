...
/decl/security_state/New()
	...
	var/severe_index = index_of(severe_security_level)
	var/high_index = index_of(high_security_level)
...
/decl/security_state/proc/index_of(var/given_security_level)
	return all_security_levels.Find(given_security_level)

/decl/security_state/proc/current_security_level_is_lower_than(var/given_security_level)
	var/current_index = index_of(current_security_level)
	var/given_index   = index_of(given_security_level)
...
/decl/security_state/proc/set_security_level(var/decl/security_level/new_security_level, var/force_change = FALSE)
	...
	var/previous_index = index_of(previous_security_level)
	var/new_index      = index_of(new_security_level)
