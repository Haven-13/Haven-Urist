...
/datum/sound_token/New(atom/source, sound_id, sound/sound, range = 4, prefer_mute = FALSE)
	...
	GLOB.destroyed_event.register(source, src, TYPE_PROC_REF(/datum/sound_token, Stop))
...
/datum/sound_token/proc/Stop()
	...
	GLOB.destroyed_event.unregister(source, src, TYPE_PROC_REF(/datum/sound_token, Stop))
...
/datum/sound_token/proc/PrivUpdateListener(listener, update_sound = FALSE)
...
/obj/sound_test
	var/sound = 'resources/sound/misc/TestLoop1.ogg'
