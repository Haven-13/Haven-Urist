...
/decl/appearance_handler/cardborg/proc/get_image_from_backpack(var/mob/living/carbon/human/H)
	...
	var/image/I = image(icon = 'resources/icons/mob/robots.dmi', icon_state = ca.icon_state, loc = H)
	I.override = 1
	I.overlays += image(icon = 'resources/icons/mob/robots.dmi', icon_state = "eyes-[ca.icon_state]") //gotta look realistic
	return I
