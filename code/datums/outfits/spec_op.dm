...
/decl/hierarchy/outfit/death_command/equip(mob/living/carbon/human/H, equip_adjustments)
...
/decl/hierarchy/outfit/syndicate_command/equip(mob/living/carbon/human/H, equip_adjustments)
