...
/decl/hierarchy/outfit/death_command/equip(var/mob/living/carbon/human/H, equip_adjustments)
...
/decl/hierarchy/outfit/syndicate_command/equip(var/mob/living/carbon/human/H, equip_adjustments)
