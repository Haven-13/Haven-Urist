...
/obj/machinery/computer/ship/helm/proc/look(mob/user)
	...
	GLOB.moved_event.register(user, src, TYPE_PROC_REF(/obj/machinery/computer/ship/helm, unlook))
...
/obj/machinery/computer/ship/helm/proc/unlook(mob/user)
	...
	GLOB.moved_event.unregister(user, src, TYPE_PROC_REF(/obj/machinery/computer/ship/helm, unlook))
	GLOB.stat_set_event.unregister(user, src, TYPE_PROC_REF(/obj/machinery/computer/ship/helm, unlook))
