/obj/item/weapon/gun/energy/gun/small/secure
	...
	icon = 'resources/icons/obj/gun_secure.dmi'
	item_icons = list(
		slot_l_hand_str = 'resources/icons/mob/onmob/items/lefthand_guns_secure.dmi',
		slot_r_hand_str = 'resources/icons/mob/onmob/items/righthand_guns_secure.dmi',
		)
