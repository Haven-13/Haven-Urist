...
/datum/computer_file/program/reports
	...
	ui_module_path = /datum/ui_module/program/reports
...
/datum/ui_module/program/reports/proc/switch_state(new_state)
...
/datum/ui_module/program/reports/proc/close_report()
	QDEL_NULL(selected_report)
	saved_report = null

/datum/ui_module/program/reports/proc/save_report(mob/user, save_as)
...
/datum/ui_module/program/reports/proc/load_report(mob/user)
	if(!program.computer || !program.computer.hard_drive)
		to_chat(user, "Unable to find hard drive.")
		return
	var/choices = list()
...
/datum/ui_module/program/reports/Topic(href, href_list)
	if(..())
		return 1
	var/mob/user = usr
