...
/datum/ui_module/alarm_monitor/New()
	..()
	alarm_handlers = list()
...
/datum/ui_module/alarm_monitor/all/New()
	..()
	alarm_handlers = SSalarm.all_handlers

/datum/ui_module/alarm_monitor/engineering/New()
	..()
	alarm_handlers = list(atmosphere_alarm, camera_alarm, fire_alarm, power_alarm)

/datum/ui_module/alarm_monitor/security/New()
	..()
	alarm_handlers = list(camera_alarm, motion_alarm)

/datum/ui_module/alarm_monitor/proc/register_alarm(var/object, var/procName)
	for(var/datum/alarm_handler/AH in alarm_handlers)
		AH.register_alarm(object, procName)

/datum/ui_module/alarm_monitor/proc/unregister_alarm(var/object)
	for(var/datum/alarm_handler/AH in alarm_handlers)
		AH.unregister_alarm(object)

/datum/ui_module/alarm_monitor/proc/all_alarms()
...
/datum/ui_module/alarm_monitor/proc/major_alarms()
	var/list/all_alarms = new()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/ui_module/alarm_monitor/proc/has_major_alarms()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/ui_module/alarm_monitor/proc/minor_alarms()
	var/list/all_alarms = new()
	for(var/datum/alarm_handler/AH in alarm_handlers)
...
/datum/ui_module/alarm_monitor/Topic(ref, href_list)
	if(..())
		return 1
