...
/proc/infect_mob_random_virus(mob/living/carbon/M, severity = VIRUS_COMMON)
	var/datum/disease2/disease/D = new /datum/disease2/disease
...
/mob/living/carbon/proc/spread_disease_to(mob/living/carbon/victim, vector = "Proximity")
	if (src == victim)
		return "retardation"
