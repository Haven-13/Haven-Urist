...
/datum/disease2/effect/proc/generate(copy_data)
...
/datum/disease2/effect/monkey/activate(mob/living/carbon/human/mob,multiplier)
	mob.monkeyize()
...
/datum/disease2/effect/telepathic/activate(mob/living/carbon/human/mob,multiplier)
...
/datum/disease2/effect/confusion/activate(mob/living/carbon/human/mob,multiplier)
