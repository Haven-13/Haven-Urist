...
//		M.show_message("<span class='danger'>[src] slams into [A]!</span>",1,"<span class='danger'>You hear a loud slam!</span>",2)
	...
	apply_damage(b_loss/3, DAMAGE_TYPE_BRUTE, BP_HEAD, blocked, 0, "Airflow")

	blocked = run_armor_check(BP_CHEST,"melee")
	apply_damage(b_loss/3, DAMAGE_TYPE_BRUTE, BP_CHEST, blocked, 0, "Airflow")

	blocked = run_armor_check(BP_GROIN,"melee")
	apply_damage(b_loss/3, DAMAGE_TYPE_BRUTE, BP_GROIN, blocked, 0, "Airflow")
