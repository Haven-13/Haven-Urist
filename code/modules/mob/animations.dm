...
/mob/proc/phase_in(var/turf/T)
	...
	playsound(T, 'resources/sound/effects/phasein.ogg', 25, 1)
	playsound(T, 'resources/sound/effects/sparks2.ogg', 50, 1)
	anim(T,src,'resources/icons/mob/mob.dmi',,"phasein",,dir)

/mob/proc/phase_out(var/turf/T)
	if(!T)
		return
	playsound(T, "sparks", 50, 1)
	anim(T,src,'resources/icons/mob/mob.dmi',,"phaseout",,dir)
