...
/mob/living/simple_animal/hostile/proc/CanAttack(atom/the_target)
...
/mob/living/simple_animal/hostile/proc/Goto(atom/target, delay, minimum_distance)
...
/mob/living/simple_animal/hostile/proc/Shoot(atom/target, start, user, bullet = 0)
	if(target == start)
		return
...
/mob/living/simple_animal/hostile/proc/DestroySurroundings(forced=0, list/directions=null, special_attacktext=null)
