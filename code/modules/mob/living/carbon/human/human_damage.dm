...
/mob/living/carbon/human/apply_damage(damage = 0, damagetype = DAMAGE_TYPE_BRUTE, def_zone = null, blocked = 0, damage_flags = 0, obj/used_weapon = null, obj/item/organ/external/given_organ = null)
...
/mob/living/carbon/human/apply_effect(effect = 0,effecttype = DAMAGE_TYPE_STUN, blocked = 0)
