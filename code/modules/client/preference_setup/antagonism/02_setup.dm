...
/datum/category_item/player_setup_item/antagonism/basic/load_character(savefile/S)
	...
	from_file(S["antagonism/uplink_sources"], uplink_order)
	from_file(S["antagonism/exploit_record"], pref.exploit_record)
...
/datum/category_item/player_setup_item/antagonism/basic/save_character(savefile/S)
	...
	to_file(S["antagonism/uplink_sources"], uplink_order)
	to_file(S["antagonism/exploit_record"], pref.exploit_record)
