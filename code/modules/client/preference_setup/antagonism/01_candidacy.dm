...
/datum/category_item/player_setup_item/antagonism/candidacy/load_character(savefile/S)
	from_file(S["antagonism/be_special"],           pref.be_special_role)
	from_file(S["antagonism/never_be_special"],     pref.never_be_special_role)

/datum/category_item/player_setup_item/antagonism/candidacy/save_character(savefile/S)
	to_file(S["antagonism/be_special"],             pref.be_special_role)
	to_file(S["antagonism/never_be_special"],       pref.never_be_special_role)
