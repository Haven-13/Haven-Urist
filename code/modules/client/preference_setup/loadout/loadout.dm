...
/datum/category_item/player_setup_item/loadout/load_character(savefile/S)
	from_file(S["loadout/gear_list"], pref.gear_list)
	from_file(S["loadout/gear_slot"], pref.gear_slot)

/datum/category_item/player_setup_item/loadout/save_character(savefile/S)
	to_file(S["loadout/gear_list"], pref.gear_list)
	to_file(S["loadout/gear_slot"], pref.gear_slot)
