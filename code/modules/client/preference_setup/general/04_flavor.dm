...
/datum/category_item/player_setup_item/physical/flavor/load_character(savefile/S)
	from_file(S["flavor_texts/general"], pref.flavor_texts["general"])
	from_file(S["flavor_texts/head"], pref.flavor_texts["head"])
	from_file(S["flavor_texts/face"], pref.flavor_texts["face"])
	from_file(S["flavor_texts/eyes"], pref.flavor_texts["eyes"])
	from_file(S["flavor_texts/torso"], pref.flavor_texts["torso"])
	from_file(S["flavor_texts/arms"], pref.flavor_texts["arms"])
	from_file(S["flavor_texts/hands"], pref.flavor_texts["hands"])
	from_file(S["flavor_texts/legs"], pref.flavor_texts["legs"])
	from_file(S["flavor_texts/feet"], pref.flavor_texts["feet"])

	//Flavour text for robots.
	from_file(S["flavour_texts_robot/Default"], pref.flavour_texts_robot["Default"])
	for(var/module in GLOB.robot_module_types)
		from_file(S["flavour_texts_robot/[module]"], pref.flavour_texts_robot[module])

/datum/category_item/player_setup_item/physical/flavor/save_character(savefile/S)
	to_file(S["flavor_texts/general"], pref.flavor_texts["general"])
	to_file(S["flavor_texts/head"], pref.flavor_texts["head"])
	to_file(S["flavor_texts/face"], pref.flavor_texts["face"])
	to_file(S["flavor_texts/eyes"], pref.flavor_texts["eyes"])
	to_file(S["flavor_texts/torso"], pref.flavor_texts["torso"])
	to_file(S["flavor_texts/arms"], pref.flavor_texts["arms"])
	to_file(S["flavor_texts/hands"], pref.flavor_texts["hands"])
	to_file(S["flavor_texts/legs"], pref.flavor_texts["legs"])
	to_file(S["flavor_texts/feet"], pref.flavor_texts["feet"])

	to_file(S["flavour_texts_robot/Default"], pref.flavour_texts_robot["Default"])
	for(var/module in GLOB.robot_module_types)
		to_file(S["flavour_texts_robot/[module]"], pref.flavour_texts_robot[module])

/datum/category_item/player_setup_item/physical/flavor/setup_character(mob/living/carbon/human/character, is_preview_copy)
