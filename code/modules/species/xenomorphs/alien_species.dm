...
/datum/hud_data/alien
	...
	gear = list(
		"o_clothing" =   list("loc" = UI_INVENTORY_SLOT_BELT,      "name" = "Suit",         "slot" = slot_wear_suit, "state" = "equip",  "dir" = SOUTH),
		"head" =         list("loc" = UI_INVENTORY_SLOT_CARD,        "name" = "Hat",          "slot" = slot_head,      "state" = "hair"),
