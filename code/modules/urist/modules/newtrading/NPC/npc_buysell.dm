/mob/living/simple_animal/hostile/npc/proc/player_sell(obj/O, mob/M, worth, resell = 1)
	if(no_resell)
		resell = 0
...
/mob/living/simple_animal/hostile/npc/proc/try_list_for_sale(obj/O)
	var/datum/trade_item/T = trade_items_inventory_by_type[O.type]
	if(T)
		T.quantity += 1
...
/mob/living/simple_animal/hostile/npc/proc/player_buy(item_name, mob/M)
...
/mob/living/simple_animal/hostile/npc/proc/GiveItem(datum/trade_item/D, mob/M)
...
/mob/living/simple_animal/hostile/npc/proc/GiveFreeItem(datum/trade_item/D, mob/M)
	var/obj/O = new D.item_type(M.loc)
	M.put_in_hands(O)
...
/mob/living/simple_animal/hostile/npc/proc/CanPurchase(mob/M, access)
