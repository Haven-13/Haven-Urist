	...
	if(href_list["add"])
		...
		if(href_list["type"])
			...
			if(ID == 2 | ID == 3)
				...
				if(brand == 1)
					if(ID == 2)
						reagents.add_reagent(/datum/reagent/drink/space_cola,5)
					else
						reagents.add_reagent(/datum/reagent/ethanol/coffee/kahlua,5)
				else if(brand == 2)
					if(ID == 2)
						reagents.add_reagent(/datum/reagent/drink/dr_gibb,5)
					else
						reagents.add_reagent(/datum/reagent/ethanol/vodka,5)
				else if(brand == 3)
					if(ID == 2)
						reagents.add_reagent(/datum/reagent/drink/space_up,5)
					else
						reagents.add_reagent(/datum/reagent/ethanol/rum,5)
				else if(brand == 4)
					if(ID == 2)
						reagents.add_reagent(/datum/reagent/drink/spacemountainwind,5)
					else
						reagents.add_reagent(/datum/reagent/ethanol/gin,5)
			else if(ID == 4)
				if(reagents.total_volume <= 500 & reagents.total_volume >= 15)
					reagents.add_reagent(/datum/reagent/drink/milk/cream,(30 - reagents.total_volume))
				else if(reagents.total_volume <= 15)
					reagents.add_reagent(/datum/reagent/drink/milk/cream,(15 - reagents.total_volume))
			else if(ID == 5)
				if(reagents.total_volume <= 500 & reagents.total_volume >= 15)
