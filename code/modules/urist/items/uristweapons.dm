...
Please keep it tidy, by which I mean put comments describing the item before the entry. Icons go to 'resources/icons/urist/items/uristweapons.dmi' -Glloyd */
...
/obj/item/weapon/cane/crutch
	...
	icon = 'resources/icons/urist/items/uristweapons.dmi'
	item_icons = list(
			slot_l_hand_str = 'resources/icons/uristmob/items_lefthand.dmi',
			slot_r_hand_str = 'resources/icons/uristmob/items_righthand.dmi',
		)
	icon_state = "crutch"
	item_state = "crutch"
