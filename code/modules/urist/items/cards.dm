...
/obj/item/toy/card/attack_self(mob/user as mob)
	..()
	Flip()
	return

/obj/item/toy/card/attackby(obj/item/weapon/W as obj, mob/user as mob)
	var/mob/M = user
...
/obj/item/toy/cardhand/attackby(obj/item/weapon/W as obj, mob/user as mob)
	var/mob/M = user
	if(istype(W,/obj/item/toy/card) && loc==user)
		M.drop_item()
		W.loc = src
...
/obj/item/toy/cardhand/verb/show()
	set name = "Show hand"
	set category = "Object"
...
/obj/item/toy/cardhand/verb/pick_card()
	set name = "Pick card"
	set category = "Object"
...
/obj/item/weapon/storage/deck/New()
	..()
...
/obj/item/weapon/storage/deck/verb/shuffle_deck()
...
/obj/item/weapon/storage/deck/verb/pull_card()
	set name = "Pull card"
	set category = "Object"
	set src in oview(1)
...
/obj/item/weapon/storage/deck/attack_self(mob/user as mob)
	pull_card()
