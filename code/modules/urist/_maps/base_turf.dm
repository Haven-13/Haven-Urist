...
var/global/list/base_turf_by_z = list(
	"5" = /turf/simulated/floor/plating/airless/asteroid
	)
...
/area/syndicate_station/mining/base_turf = /turf/simulated/floor/planet/jungle/clear

/area/skipjack_station/mining/base_turf = /turf/simulated/floor/planet/jungle/clear
