...
/obj/vehicle/train/cargo/engine/fourwheeler/proc/update_dir_fourwheel_overlays()
	...
	if(src.dir == NORTH||SOUTH)
		if(src.dir == NORTH)
			var/image/I = new(icon = 'resources/icons/urist/vehicles/uristvehicles.dmi', icon_state = "4wheeler_north", layer = src.layer + 0.2) //over mobs
			overlays += I
		else if(src.dir == SOUTH)
			var/image/I = new(icon = 'resources/icons/urist/vehicles/uristvehicles.dmi', icon_state = "4wheeler_south", layer = src.layer + 0.2) //over mobs
			overlays += I
