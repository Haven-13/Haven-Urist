...
/datum/reagent/acetone/touch_obj(obj/O)
...
/datum/reagent/hydrazine/affect_touch(mob/living/carbon/M, alien, removed)
...
/datum/reagent/acid/affect_touch(mob/living/carbon/M, alien, removed)
	if(is_human_mob(M))
