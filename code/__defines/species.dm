// Species flags.
#define SPECIES_FLAG_NO_MINOR_CUT        0x0001  // Can step on broken glass with no ill-effects. Either thick skin (vox), cut resistant (slimes) or incorporeal (shadows)
