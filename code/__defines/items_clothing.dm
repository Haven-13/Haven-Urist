...
#define BODYTEMP_COLD_DAMAGE_LIMIT 273.15 // The limit the human body can take before it starts taking damage from coldness.
...
var/list/default_onmob_icons = list(
		slot_l_hand_str = 'resources/icons/mob/onmob/items/lefthand.dmi',
		slot_r_hand_str = 'resources/icons/mob/onmob/items/righthand.dmi',
		slot_belt_str = 'resources/icons/mob/onmob/belt.dmi',
		slot_back_str = 'resources/icons/mob/onmob/back.dmi',
		slot_l_ear_str = 'resources/icons/mob/onmob/ears.dmi',
		slot_r_ear_str = 'resources/icons/mob/onmob/ears.dmi',
		slot_glasses_str = 'resources/icons/mob/onmob/eyes.dmi',
		slot_wear_id_str = 'resources/icons/mob/onmob/id.dmi',
		slot_w_uniform_str = 'resources/icons/mob/onmob/uniform.dmi',
		slot_wear_suit_str = 'resources/icons/mob/onmob/suit.dmi',
		slot_head_str = 'resources/icons/mob/onmob/head.dmi',
		slot_shoes_str = 'resources/icons/mob/onmob/feet.dmi',
		slot_wear_mask_str = 'resources/icons/mob/onmob/mask.dmi',
		slot_handcuffed_str = 'resources/icons/mob/onmob/misc.dmi',
		slot_legcuffed_str = 'resources/icons/mob/onmob/misc.dmi',
		slot_gloves_str = 'resources/icons/mob/onmob/hands.dmi',
		slot_s_store_str = 'resources/icons/mob/onmob/belt_mirror.dmi',
		slot_tie_str = 'resources/icons/mob/onmob/ties.dmi'
		)
