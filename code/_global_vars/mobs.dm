...
GLOBAL_LIST_EMPTY(simple_mob_list)  //List of all alive simplemobs, including clientless
...
GLOBAL_LIST_EMPTY(matrix_mob_list)  //List of all matrix mobs, excluding clientless. Excludes /mob/matrix/ice
