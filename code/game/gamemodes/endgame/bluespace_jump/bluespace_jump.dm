...
/obj/effect/bluegoast/New(nloc, ndaddy)
	...
	GLOB.moved_event.register(daddy, src, TYPE_PROC_REF(/obj/effect/bluegoast, mirror))
	GLOB.dir_set_event.register(daddy, src, TYPE_PROC_REF(/obj/effect/bluegoast, mirror_dir))
