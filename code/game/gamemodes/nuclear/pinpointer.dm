/obj/item/weapon/pinpointer
	name = "pinpointer"
	icon = 'resources/icons/obj/pinpointer.dmi'
	icon_state = "pinoff"
...
/obj/item/weapon/pinpointer/Process()
	...
	if(beeping == 0)
		...
		playsound(loc, 'resources/sound/machines/buttonbeep.ogg', 1, frequency = freq_mod)
...
/obj/item/weapon/pinpointer/nukeop/Process()
	...
	if(new_mode)
		playsound(loc, 'resources/sound/machines/twobeep.ogg', 50, 1)
