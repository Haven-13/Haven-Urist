...
/obj/structure/grille/bullet_act(var/obj/item/projectile/Proj)
	...
	if(passthrough)
		. = PROJECTILE_CONTINUE
		damage = between(0, (damage - Proj.damage)*(Proj.damage_type == DAMAGE_TYPE_BRUTE? 0.4 : 1), 10) //if the bullet passes through then the grille avoids most of the damage
