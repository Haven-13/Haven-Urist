...
/obj/structure/fireaxecabinet/attack_generic(var/mob/user, var/damage, var/attack_verb, var/wallbreaker)
	...
	playsound(user, 'resources/sound/effects/Glasshit.ogg', 50, 1)
	...
	unlocked = 1
	open = 1
	playsound(user, 'resources/sound/effects/Glassbr3.ogg', 100, 1)
	update_icon()
...
/obj/structure/fireaxecabinet/proc/toggle_lock(var/mob/user)
	...
	if(shattered)
		...
		unlocked = !unlocked
		playsound(user, 'resources/sound/machines/lockreset.ogg', 50, 1)
