...
/obj/structure/bed/chair/wheelchair/Bump(atom/A)
	...
	if(propelled || (pulling && (pulling.a_intent == I_HURT)))
		...
		occupant.throw_at(A, 3, propelled)
		occupant.apply_effect(6, DAMAGE_TYPE_STUN, blocked)
		...
		if(istype(A, /mob/living))
			...
			victim.apply_effect(6, DAMAGE_TYPE_STUN, blocked)
			victim.apply_effect(6, DAMAGE_TYPE_WEAKEN, blocked)
			victim.apply_effect(6, DAMAGE_TYPE_STUTTER, blocked)
			victim.apply_damage(10, DAMAGE_TYPE_BRUTE, def_zone, blocked)
		if(pulling)
