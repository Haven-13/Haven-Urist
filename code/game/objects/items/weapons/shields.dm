...
/obj/item/weapon/shield/proc/get_block_chance(mob/user, damage, atom/damage_source = null, mob/attacker = null)
...
/obj/item/weapon/shield/riot/get_block_chance(mob/user, damage, atom/damage_source = null, mob/attacker = null)
	if(istype(damage_source, /obj/item/projectile))
		var/obj/item/projectile/P = damage_source
...
/obj/item/weapon/shield/buckler/get_block_chance(mob/user, damage, atom/damage_source = null, mob/attacker = null)
...
/obj/item/weapon/shield/energy/get_block_chance(mob/user, damage, atom/damage_source = null, mob/attacker = null)
	if(istype(damage_source, /obj/item/projectile))
		var/obj/item/projectile/P = damage_source
