...
/obj/item/weapon/proc/backstab(mob/living/target, mob/user, damage = 30, damage_type = DAMAGE_TYPE_BRUTE, damage_flags, target_zone = BP_CHEST, location_check = TRUE)
