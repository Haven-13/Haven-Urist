...
/obj/item/mecha_parts/mecha_equipment
	...
	icon = 'resources/icons/mecha/mecha_equipment.dmi'
...
/obj/item/mecha_parts/mecha_equipment/proc/destroy()//missiles detonating, teleporter creating singularity?
	if(chassis)
		...
		if(istype(src, /obj/item/mecha_parts/mecha_equipment/weapon))
			sound_to(chassis.occupant, sound('resources/sound/mecha/weapdestr.ogg',volume=50))
		else
			sound_to(chassis.occupant, sound('resources/sound/mecha/critdestr.ogg',volume=50))
	spawn
		qdel(src)
	return
