...
/obj/machinery/door/airlock/multi_tile
	...
	fill_file = 'resources/icons/obj/doors/double/fill_steel.dmi'
	color_file = 'resources/icons/obj/doors/double/color.dmi'
	color_fill_file = 'resources/icons/obj/doors/double/fill_color.dmi'
	stripe_file = 'resources/icons/obj/doors/double/stripe.dmi'
	stripe_fill_file = 'resources/icons/obj/doors/double/fill_stripe.dmi'
	glass_file = 'resources/icons/obj/doors/double/fill_glass.dmi'
	bolts_file = 'resources/icons/obj/doors/double/lights_bolts.dmi'
	deny_file = 'resources/icons/obj/doors/double/lights_deny.dmi'
	lights_file = 'resources/icons/obj/doors/double/lights_green.dmi'
	panel_file = 'resources/icons/obj/doors/double/panel.dmi'
	welded_file = 'resources/icons/obj/doors/double/welded.dmi'
	emag_file = 'resources/icons/obj/doors/double/emag.dmi'
	width = 2
	appearance_flags = 0
	opacity = 1
