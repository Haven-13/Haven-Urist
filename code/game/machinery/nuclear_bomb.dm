...
/obj/item/weapon/disk/nuclear/Initialize()
	...
	GLOB.moved_event.register(src, src, TYPE_PROC_REF(/obj/item/weapon/disk/nuclear, check_z_level))

/obj/item/weapon/disk/nuclear/proc/check_z_level()
	if(!(istype(SSticker.mode, /datum/game_mode/nuclear)))
		GLOB.moved_event.unregister(src, src, TYPE_PROC_REF(/obj/item/weapon/disk/nuclear, check_z_level)) // However, when we are certain unregister if necessary
		return
...
/obj/item/weapon/disk/nuclear/Destroy()
	GLOB.moved_event.unregister(src, src, TYPE_PROC_REF(/obj/item/weapon/disk/nuclear, check_z_level))
	nuke_disks -= src
	if(!nuke_disks.len)
