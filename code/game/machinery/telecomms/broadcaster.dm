...
/proc/Broadcast_Message(
		datum/radio_frequency/connection,
		mob/M,
		vmask,
		vmessage,
	...
	for (var/mob/R in receive)
		...
		if(data == 3 && is_ghost(R) && R.get_preference_value(/datum/client_preference/ghost_radio) == GLOB.PREF_ALL_CHATTER)
			continue
